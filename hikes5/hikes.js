...
export default class Hikes {
  ...
  addHikeListener() {
    // We need to loop through the children of our list and 
    //attach a listener to each, remember though that children is a 
    //nodeList...not an array. So in order to use something like a 
    //forEach we need to convert it to an array.
